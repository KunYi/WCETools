...
#include "UpdateID.h"                // Program-specific stuff
#include "nand.h"
#include "resource.h"
...
// Global data
//
const TCHAR szAppName[] = TEXT ("UpdateID");
...
BOOL DoInitDlgMain (HWND hWnd, UINT wMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    SendDlgItemMessage (hWnd, IDC_EDIT2, EM_SETLIMITTEXT, 11, 0);
    return 0;
}
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
//
LPARAM DoUpdateID (HWND hWnd, WORD idItem, HWND hwndCtl, WORD wNotifyCode)
{
	TCHAR szString[64];
    ...
    else
    {
        ...
        {
            MessageBox(hWnd, TEXT("Update ID failed"), TEXT("Update ID"), MB_OK);
            return 0;
        }
        ...
        {
            MessageBox(hWnd, TEXT("Update ID succeeded"), TEXT("Update ID"), MB_OK);
        }
    }
    return 0;
}
